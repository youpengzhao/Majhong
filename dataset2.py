import torch
import numpy as np
import os,time,math,fileinput,random
...
def dividedataset(datatxt,legaltxt,trainfile,legalfile,testfile,test_legalfile):
    datatxt=datatxt+'1.txt'
    legaltxt=legaltxt+'1.txt'
    ...
    trainloader = data.DataLoader(dataset=totaldata, batch_size=10, sampler=train_sampler)
...
dir2 = './p0winresult'
datatxt='./divide/whole/'
legaltxt='./divide/whole/legal'
